import { Eye, EyeOff, Hash, Lock, Mail, User, UserCheck } from "lucide-react";
...
export default function LoginPage({ onLoginSuccess }: LoginPageProps) {
  ...
  async function handleSignIn(e: React.FormEvent) {
    ...
    if (!actor) {
      setSiError("Connecting to server, please wait a moment and try again.");
      return;
    }
    setSiLoading(true);
    setSiError("");
  ...
  async function handleRegister(e: React.FormEvent) {
    ...
    if (!actor) {
      setRegError("Connecting to server, please wait a moment and try again.");
      return;
    }
